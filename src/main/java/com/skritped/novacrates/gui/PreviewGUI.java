...
public class PreviewGUI extends InventoryGUI {
    public enum SortMode { DEFAULT, CHANCE_DESC, RARITY }

    private final JavaPlugin plugin;
    private final GUIManager guiManager;
    private final CrateManager manager;
    private final CrateDefinition crate;
    private final boolean offerOpen;

    public PreviewGUI(JavaPlugin plugin, GUIManager guiManager, CrateManager manager, CrateDefinition crate) {
        this(plugin, guiManager, manager, crate, 0, SortMode.DEFAULT, null, true);
    }

    public PreviewGUI(JavaPlugin plugin, GUIManager guiManager, CrateManager manager,
                      CrateDefinition crate, int page) {
        this(plugin, guiManager, manager, crate, page, SortMode.DEFAULT, null, true);
    }

    public PreviewGUI(JavaPlugin plugin, GUIManager guiManager, CrateManager manager,
                      CrateDefinition crate, int page, SortMode sortMode, String rarityFilter, boolean offerOpen) {
        this.plugin = plugin;
    ...
    public void decorate(Player player) {
            ...
            if (meta != null) {
                ...
                if (meta.hasLore() && meta.getLore() != null) {
                    for (String line : meta.getLore()) {
                        ...
                        if (s.startsWith("Szansa:") || s.startsWith("Chance:") || s.startsWith("──")
                                || s.contains("ustaw wagę") || s.startsWith("PPM") || s.contains("Kliknij")) {
                            continue;
                        }
                        lore.add(line);
                    }
        ...
        if (offerOpen) {
            ...
            // 51,52,53 — open WITHOUT animation
